package com.ssz.frame.model.net.nethttp;
...
import com.ssz.frame.model.net.execption.TokenExpiredException;
import com.ssz.frame.model.net.response.ResponseCode;
import com.ssz.frame.utils.ObjectHelper;
import com.ssz.frame.utils.gsonutils.ReflectUtil;
...
//        return selfApiException(code, message);
    ...
    private static ApiException selfApiException(int httpCode, String message) throws Exception {
        ApiException ex;
        LogUtils.INSTANCE.e(TAG, "selfApiException:" + httpCode + message);
        switch (httpCode) {
