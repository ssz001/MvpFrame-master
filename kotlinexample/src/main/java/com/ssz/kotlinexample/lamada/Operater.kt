...
//    }
    ...
    fun entry(){
         ...
         *  java interface
         */
        onClick0Java(IOperate0Java { })

        onClick1Java(IOperate1Java { name ->  })

        onClick2Java(IOperate2Java{ name, age -> {} })
    ...
    fun onClick0Java(operate0: IOperate0Java){

    }

    fun onClick1Java(operate1: IOperate1Java){

    }

    fun onClick2Java(operate2: IOperate2Java){
