package com.ssz.baselibrary.utils.network;
 ...
 * AUTO 和 mobile 和其它部分具有包含关系;
 * step1: registerNetWorkObserver(Object register)
 * step2:
 *     @link @NetworkListener({NetType.MOBILE_4G,NetType.NONE})
 *     public void netWorkChange(@NetType String netType){
 *         switch(netType){
...
//            }
    ...
    private final ConnectivityManager.NetworkCallback mCallBack = new ConnectivityManager.NetworkCallback(){
        ...
        public void onAvailable(Network network) {
            ...
            Log.d("dispatch","NetType on = "+netType);
            dispatch(netType);
        }
