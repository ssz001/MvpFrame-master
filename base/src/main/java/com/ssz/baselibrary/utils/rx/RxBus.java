package com.ssz.baselibrary.utils.rx;
...
public class RxBus {
     ...
     *
     *     发送
     * mBtnReturn.setOnClickListener(new IView.OnClickListener() {
     *     @Override
     *    public void onClick(IView mView) {
     *           RxBus.get().send(new Event(mEtNext.getText().toString()));
     *         finish();
     *      }
     * });
     */
