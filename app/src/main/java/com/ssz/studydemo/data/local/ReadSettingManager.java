...
import com.ssz.frame.utils.SharedPreUtils;
import com.ssz.frame.utils.StringUtils;
import com.ssz.studydemo.widget.book.page.PageMode;
import com.ssz.studydemo.widget.book.page.PageStyle;
...
public class ReadSettingManager {
    ...
    public static final String SHARED_READ_CONVERT_TYPE = StringUtils.SHARED_READ_CONVERT_TYPE;
    ...
    public int getTextSize() {
        return sharedPreUtils.getInt(SHARED_READ_TEXT_SIZE, ScreenUtil.spToPx(28));
    }
