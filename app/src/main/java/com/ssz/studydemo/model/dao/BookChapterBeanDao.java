...
public class BookChapterBeanDao extends AbstractDao<BookChapterBean, String> {
    ...
    public static class Properties {
        ...
        public final static Property ValidInZhuishu = new Property(5, boolean.class, "validInZhuishu", false, "VALID_IN_ZHUISHU");
        public final static Property BookId = new Property(6, String.class, "bookId", false, "BOOK_ID");
        public final static Property Start = new Property(7, long.class, "start", false, "START");
        public final static Property End = new Property(8, long.class, "end", false, "END");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_CHAPTER_BEAN\" (" + //
                ...
                "\"VALID_IN_ZHUISHU\" INTEGER NOT NULL ," + // 5: validInZhuishu
    ...
    protected final void bindValues(DatabaseStatement stmt, BookChapterBean entity) {
        ...
        stmt.bindLong(6, entity.getValidInZhuishu() ? 1L: 0L);
    ...
    public BookChapterBean readEntity(Cursor cursor, int offset) {
        BookChapterBean entity = new BookChapterBean( //
            ...
            cursor.getShort(offset + 5) != 0, // validInZhuishu
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // bookId
            cursor.getLong(offset + 7), // start
            cursor.getLong(offset + 8) // end
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BookChapterBean entity, int offset) {
        ...
        entity.setValidInZhuishu(cursor.getShort(offset + 5) != 0);
        entity.setBookId(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setStart(cursor.getLong(offset + 7));
        entity.setEnd(cursor.getLong(offset + 8));
     }
